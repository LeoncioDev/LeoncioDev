...
<table width="100%">
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <br/>
      <p>Real-time crypto dashboard. Live prices via Binance WebSocket, candlestick charts, Fear & Greed index, and a currency converter.</p>
  ...
  <tr>
    <td colspan="2" valign="top">
      ...
      <br/>
      <p align="center">Personal portfolio — HTML, CSS, vanilla JS. No frameworks, no build tools. Fast, responsive, deployed with auto-deploy via GitHub.</p>
      <div align="center">
